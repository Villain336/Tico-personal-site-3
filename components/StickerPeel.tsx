'use client';
/* eslint-disable @next/next/no-img-element -- stickers are small SVGs; next/image adds nothing and breaks the GSAP-driven filters */
...
const StickerPeel: React.FC<StickerPeelProps> = ({
  ...
  // Unique filter ids so several stickers can coexist on one page.
